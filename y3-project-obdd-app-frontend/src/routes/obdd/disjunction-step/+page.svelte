<script>
	...
	async function doPost() {
		const res = await fetch('http://localhost:8080/disjunction/step', {
			method: 'POST',
			mode: 'cors',
...
{#if show_info}
	<p id="init">
		This page allows you to visualise how the disjunction algorithm works step by step on a global
...
{#if !show_info}
	<p id="init"><b>Disjunction, step by step</b></p>
	<br />
